...
describe("All Contract Test" , () => {
    ...
    */
    ...
    it("add New Collection" , async () => {
        ...
        let value = BigNumber.from("100000000000000000000");
        ...
        // console.log(await NFTCollection2.connect(addr1).setApprovalForAll(NFTCollection2.address , true));
        console.log('------------------------------------------------------------------------------------------------------------------');
        console.log(await RewardContract.connect(addr1).setApprovalForAll(addr3.address , true));
        // console.log(await NFTCollection1.isApprovedForAll( addr1.address ,NFTCollection1.address));
        // console.log(await NFTCollection2.isApprovedForAll( addr1.address ,NFTCollection2.address));

        console.log('---------my own test-----------');
        console.log(await NFTCollection1.connect(addr1).ownedTokens(addr1.address));
        ...
        console.log('balance addr10 before buy', ethers.utils.formatUnits(await BusdContract.connect(addr10).balanceOf(addr10.address),decimals));
        console.log('balance addr3 sponsor of addr10 before buy', ethers.utils.formatUnits(await BusdContract.connect(addr3).balanceOf(addr3.address),decimals));
        ...
        console.log('balance addr10 after buy reward box 9', ethers.utils.formatUnits(await BusdContract.connect(addr10).balanceOf(addr10.address),decimals));
        console.log('balance addr3 sponsor of addr10 after buy reward box 9', ethers.utils.formatUnits(await BusdContract.connect(addr3).balanceOf(addr3.address),decimals));
